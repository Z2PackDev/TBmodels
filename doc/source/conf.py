...
version = '.'.join(tbmodels.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = tbmodels.__version__
...
html_use_opensearch = 'http://tbmodels.ethz.ch/doc'
...
latex_documents = [
  ('index', 'TBmodels.tex', u'TBmodels Documentation',
...
man_pages = [
    ('index', 'tbmodels', u'TBmodels Documentation',
     [u'Dominik Gresch'], 1)
]
...
texinfo_documents = [
  ('index', 'TBmodels', u'TBmodels Documentation',
   u'Dominik Gresch', 'TBmodels', 'One line description of project.',
   'Miscellaneous'),
]
