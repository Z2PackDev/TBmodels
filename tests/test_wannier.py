...
@pytest.mark.parametrize(
    'hr_name, wsvec_name, xyz_name, win_name, pos, uc, reciprocal_lattice', [(
        'silicon_hr.dat', 'silicon_wsvec.dat', 'silicon_centres.xyz',
        'silicon.win', np.array([[0.08535249, -0.25608288, 0.08537316], [
            0.08536001, 0.08535213, 0.08536136
        ], [0.08536071, 0.08533944,
            -0.25606735], [-0.25607521, 0.08534613,
                           0.08536816], [-0.33535779, 1.00606797, -0.335358], [
                               -0.33536052, 0.66462432, -0.33534382
                           ], [-0.33535638, 0.66463603, 0.00608418],
                                 [0.00607598, 0.66462586, -0.33534919]]),
        np.array([[-2.6988, 0.0000, 2.6988], [0.0000, 2.6988, 2.6988],
                  [-2.6988, 2.6988, 0.0000]]), np.array([
        ...
        np.array([[0.08775382, -0.00245227,
                   -0.05753982], [-0.05495596, 0.14636127, -0.0485512],
                  [-0.06553189, -0.0240915,
                   0.12595038], [0.08499069, 0.09910585, 0.00461952],
                  [0.07323644, -0.0895939,
                   -0.17143996], [-0.03101997, -0.0348563, 0.01921201], [
        ...
        np.array([[2.272990, -1.312311,
                   3.953982], [0.000000, 2.624622, 3.953982],
                  [-2.272990, -1.312311, 3.953982]]), np.array([
