...
EXTRAS_REQUIRE = {
    'kwant': ['kwant'],
    'dev': [
        'pytest', 'pytest-cov', 'pythtb', 'sphinx', 'sphinx-rtd-theme==0.2.4', 'ipython>=6.2',
        'sphinx-click', 'yapf==0.29', 'pre-commit', 'prospector==1.2.0', 'pylint==2.4.4',
        'mypy==0.761'
    ],
}
...
setup(
    ...
    python_requires=">=3.6",
    install_requires=[
        'typing-extensions', 'numpy', 'scipy>=0.14', 'h5py', 'fsc.export', 'symmetry-representation>=0.2', 'click', 'bands-inspect',
        'fsc.hdf5-io>=0.3.0'
    ],
